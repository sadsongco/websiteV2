...
$message = "<p>The Exact Opposite mail unsubscribe page. You can access this through the link provided in your email";
...
if (isset($_GET['email']) && $_GET['email'] != '') {
    try {
        ...
        $secure_id = generateSecureId($_GET['email'], $db_id);
        ...
        $message = "<h2>Your email has been removed from The Exact Opposite mailing list.</h2>";
    }
